    ...
    useEffect(()=> {
        switch(`/${city}/${hotel}/${page}`){
            ...
            case `/${city}/${hotel}/menu`:
                ...
                break;
            case `/${city}/${hotel}/meeting`:
                setPageComp(<MeetingComponent />);
                break;
            case `/${city}/${hotel}/video`:
                setPageComp(<VideosComponent />);
                break;
            default: 
                setPageComp(<OverviewFieldComponent />);
        }
  ...
  return <div className={css.outerDiv}>
    <div className={css.innerDiv}>
        <div className={css.menu}>
            ...
            <NavLink to={`/${city}/${hotel}/meeting`} className={isActiveClass}>
                Meeting
            </NavLink>
            <NavLink to={`/${city}/${hotel}/video`} className={isActiveClass}>
                Videos
            </NavLink>
        </div>
